...
PORT="${PORT:-4810}"
DB_NAME="${PGDATABASE:-drone_robotics_inspection_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Drone Robotics Inspection Suite"
echo "======================================="
echo
...
echo "Starting drone robotics inspection suite frontend on http://localhost:$PORT"
echo "Login: admin@drone-robotics-inspection.local / admin123"
