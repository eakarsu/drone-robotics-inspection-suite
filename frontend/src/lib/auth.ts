export const AUTH_COOKIE = 'drone_robotics_inspection_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@drone-robotics-inspection.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@drone-robotics-inspection.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@drone-robotics-inspection.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
